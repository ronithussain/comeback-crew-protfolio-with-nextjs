...
const BookingUpdateForm = ({ data }) => {
  ...
  const handleBookService = async (e) => {
    ...
    const res = await fetch(`https://comeback-crew-ecommerce-portfolio.vercel.app/api/my-bookings/${data._id}`, {
      method: "PATCH",
      body: JSON.stringify(bookingPayload)
    });
    const updateResponse = await res.json()
    console.log("Updated response Data", updateResponse);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="form-control w-full">
              ...
              <input
                ...
                name="price"
                readOnly
                defaultValue={`$${data?.service_price || 0}`}
                className="input input-bordered w-full"
              />
            </div>
